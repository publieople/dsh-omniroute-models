...
`;
		...
		function OmnirouteModelsSection(_props) {
			...
			const [onlyDisabled, setOnlyDisabled] = (0, react.useState)(false);
			...
			async function load(p) {
				...
				try {
					...
					const data = await (await fetch(`${API}/catalog${qs}`, { cache: "no-store" })).json();
					setCatalog(data);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "om-btn",
								onClick: () => setChecked(new Set(filtered.map((m) => m.id))),
								children: "全选匹配"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "om-btn",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", { style: { width: 36 } }),
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
										...
										children: m.vendor ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: "om-badge",
											children: m.vendor
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "om-note",
						children: "保存即整体替换该路由的 models 列表（DSH 恰好能用勾选的这些）；未保存前不落盘。"
					})
				]
			});
		}
